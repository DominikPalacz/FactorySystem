...
├────────────────────────────────────────────────────────────────┤
│ [📊 Stan Magazynu] [📥 Przyjęcie] [🔄 Transfer]               │
├────────────────────────────────────────────────────────────────┤
│                                                                │
│ 📦 Stan Magazynu                                              │
│                                                                │
│  Lokacja      │ Artykuł (SKU) │ Ilość │ Ostatnia Zmiana       │
│  ──────────────┼───────────────┼───────┼──────────────────     │
│  A-01-01       │ SKU-BOLT-M8   │  90   │ 2026-01-21 15:30      │
│  B-02-05       │ SKU-BOLT-M8   │  50   │ 2026-01-21 16:45      │
│  Dock-1        │ SKU-BOLT-M8   │ 200   │ 2026-01-21 17:00      │
│                                                                │
│  [🔄 Odśwież]                                                 │
│                                                                │
└────────────────────────────────────────────────────────────────┘
...
**Cechy:**
- ✅ Duże, łatwe do kliknięcia przyciski (dla rękawiczek)
- ✅ Wysoki kontrast: ciemny `#1a1a1a` tło + pomarańczowy `#ff6b35` accent
- ✅ Czytelny tekst (base `text-lg`, headery `text-2xl`)
